...
{-# LINE 73 "Network/Socket/Info.hsc" #-}
     (AI_ADDRCONFIG, 1024),
{-# LINE 74 "Network/Socket/Info.hsc" #-}
...
{-# LINE 95 "Network/Socket/Info.hsc" #-}
    ]
...
instance Storable AddrInfo where
    sizeOf    _ = 48
{-# LINE 113 "Network/Socket/Info.hsc" #-}
...
{-# LINE 305 "Network/Socket/Info.hsc" #-}
...
{-# LINE 315 "Network/Socket/Info.hsc" #-}
...
{-# LINE 322 "Network/Socket/Info.hsc" #-}
        return (a : as)
...
{-# LINE 374 "Network/Socket/Info.hsc" #-}
            withCStringIf doService (32) $ \c_servlen c_serv ->
{-# LINE 375 "Network/Socket/Info.hsc" #-}
...
{-# LINE 440 "Network/Socket/Info.hsc" #-}
  showsPrec _ (SockAddrUnix str) = showString str

{-# LINE 444 "Network/Socket/Info.hsc" #-}
