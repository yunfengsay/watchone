...
/* package watchOne-0.1.0.0 */
#ifndef VERSION_watchOne
#define VERSION_watchOne "0.1.0.0"
#endif /* VERSION_watchOne */
#ifndef MIN_VERSION_watchOne
#define MIN_VERSION_watchOne(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_watchOne */
...
#define CURRENT_COMPONENT_ID "watchOne-0.1.0.0-inplace-watchOne"
